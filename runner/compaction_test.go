...
func (s *cancelingSummarizer) SummarizeEvents(_ context.Context, _ []*session.Event) (compaction.SummarizeResult, error) {
	return compaction.SummarizeResult{}, fmt.Errorf("summarizer model call failed: %w", context.Canceled)
}
