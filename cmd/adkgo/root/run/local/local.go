...
type sourceFlags struct {
	webUIDistrPath string // command line param
...
func init() {
	...
	localCmd.PersistentFlags().StringVarP(&flags.source.webUIDistrPath, "webui_distr_path", "w", "", "Points to a static web ui dist path with the built version of ADK Web UI (cmd/web/distr/browser in the ADK-GO repo).")
