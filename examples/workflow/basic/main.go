...
func main() {
	...
	upperFn := func(ctx context.Context, invCleanCtx agent.Context, input string) (string, error) {
		if input == "" {
	...
	suffixFn := func(ctx context.Context, invCleanCtx agent.Context, input string) (string, error) {
