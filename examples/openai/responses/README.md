...
**Ollama**, **LM Studio**, and **vLLM** builds — via a base URL. For a provider
that serves only Chat Completions, see the [completions](../completions) sample.
...
go run ./examples/openai/responses console
```
