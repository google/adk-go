...
type Config struct {
	...
	//
	// When set, structured outputs are enforced. Tools can still be used: the
	// framework may route structured replies via the set_model_response tool
	// workaround (see internal/llminternal/outputschema_processor.go).
