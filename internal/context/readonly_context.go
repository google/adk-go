...
// agent itself owns. It returns the argument unchanged only when that argument is
// already the type the procedure lives on; for every other invocation, this one
// included, it allocates a wrapper per lookup.
