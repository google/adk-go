...
func (s *bothSummarizer) SummarizeEvents(_ context.Context, events []*session.Event) (compaction.SummarizeResult, error) {
	// Content alongside an error. The framework must discard the content.
	return compaction.SummarizeResult{Content: genai.NewContentFromText("SUM", "model")}, errors.New("boom")
}
...
func (s *panickingSummarizer) SummarizeEvents(_ context.Context, _ []*session.Event) (compaction.SummarizeResult, error) {
...
func (s *usageSummarizer) SummarizeEvents(ctx context.Context, events []*session.Event) (compaction.SummarizeResult, error) {
	res, err := s.fakeSummarizer.SummarizeEvents(ctx, events)
...
func (d *usageReportingDecliner) SummarizeEvents(context.Context, []*session.Event) (compaction.SummarizeResult, error) {
	return compaction.SummarizeResult{Usage: d.usage}, nil
}
...
func (f *usageReportingFailer) SummarizeEvents(context.Context, []*session.Event) (compaction.SummarizeResult, error) {
	return compaction.SummarizeResult{Usage: f.usage}, errors.New(`summarizer stopped before finishing (finish reason "MAX_TOKENS"), so the summary is incomplete`)
}
