...
// Package streaming is an llmagent answering in two streamed chunks:
// adk-python's "streaming" scenario, STREAMING_TURNS, minus its tool call.
package streaming
...
func (Scenario) Name() string { return "streaming" }
