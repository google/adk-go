...
// Ideally we could make [agent.ReadonlyContext] be an alias
// of this internal type. However, bugs in go documentation
// affect devx, so the definition is duplicated here.
...
// Ideally we could make [agent.CallbackContext] be an alias
// of this internal type. However, bugs in go documentation
// affect devx, so the definition is duplicated here.
// Type assignability is tested from the agent package.
