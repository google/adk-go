...
var (
	nodeFunctionRegistry = make(map[string]func(context.Context, agent.Context, any) (any, error))
...
func castNodeFunction(name string, fn any) (func(context.Context, agent.Context, any) (any, error), error) {
	if typed, ok := fn.(func(context.Context, agent.Context, any) (any, error)); ok {
		return typed, nil
	}

	if strFn, ok := fn.(func(context.Context, agent.Context, string) (string, error)); ok {
		return func(ctx context.Context, invCleanCtx agent.Context, input any) (any, error) {
			var s string
			if input != nil {
			...
			return strFn(ctx, invCleanCtx, s)
		}, nil
	}
